...
/**
 * Integration tests for the ASP.NET Core "Library" server.
 *
...
export default defineConfig({
  ...
  test: {
    globalSetup: ["./int-test/asp-net/test/globalSetup.ts"],
    include: ["int-test/asp-net/test/**/*.test.ts"],
    ...
    coverage: {
      ...
      reportsDirectory: "int-test/asp-net/coverage",
    },
  },
});
