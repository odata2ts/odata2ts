...
/**
 * Integration tests for the Apache Olingo 2 "Library" server.
 *
...
export default defineConfig({
  ...
  test: {
    globalSetup: ["./int-test/olingo-v2/test/globalSetup.ts"],
    include: ["int-test/olingo-v2/test/**/*.test.ts"],
    ...
    coverage: {
      ...
      reportsDirectory: "int-test/olingo-v2/coverage",
    },
  },
});
