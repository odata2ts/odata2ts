...
import { ODataConcurrencyError, ODataResponseModel } from "@odata2ts/odata-service";
...
describe("Olingo Library: CRUD operations", () => {
  ...
  test("read entity collection", async () => {
    ...
    expectTypeOf(result).toEqualTypeOf<ODataResponseModel<ODataCollectionResponseV2<Book>>>();
  });
