...
export class MockODataClient implements ODataHttpClient<MockRequestConfig> {
  ...
  public lastData?: any;
  public lastOperation?: "GET" | "POST" | "PUT" | "PATCH" | "DELETE" | "MERGE";
  ...
  merge<ResponseModel>(url: string, data: any, requestConfig?: MockRequestConfig): ODataResponse<ResponseModel> {
    this.lastUrl = url;
    this.lastData = data;
    this.lastOperation = "MERGE";
