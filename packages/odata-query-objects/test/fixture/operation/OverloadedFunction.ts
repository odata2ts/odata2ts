...
import { QBooleanParam, QFunction, QNumberParam, QStringParam, ValueResponseConverterV4 } from "../../../src";
...
export class QOverloadedFunction extends QFunction<OverloadedFunctionParamModel, ODataValueResponseV4<boolean>> {
