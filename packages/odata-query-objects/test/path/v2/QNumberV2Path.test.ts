...
describe("QNumberV2Path test", () => {
  let toTest: QNumberV2Path;
  let otherProp: QNumberV2Path;

  beforeEach(() => {
    toTest = new QNumberV2Path("Price");
    otherProp = new QNumberV2Path("Budget");
  });
  ...
  test("with converter", () => {
    const testWithConv = new QNumberV2Path("ID", numberToStringConverter);
