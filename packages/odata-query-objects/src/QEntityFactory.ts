...
export class QEntityFactory {
   ...
   *
   * @param keys object specifying the id of the entity
   * @returns id string, e.g. "number=3,application='M'"
   */
  static createKey<TypeModel, KeyModel extends keyof TypeModel>(keys: { [Key in KeyModel]: TypeModel[Key] }): string {
