...
import { ExpandingODataUriBuilderV2 } from "./v2/ExpandingODataUriBuilderV2";
import { ReturnType } from "@odata2ts/odata2model/lib/data-model/edmx/ODataEdmxModelBase";
...
export class ODataUriBuilderBase<Q extends QueryObject> {
