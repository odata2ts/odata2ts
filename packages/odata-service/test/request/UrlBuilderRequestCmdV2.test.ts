...
import { DEFAULT_HEADERS, ODataResponseModel, UrlBuilderRequestCmdV2 } from "../../src";
...
describe("UrlBuilderRequestCmd tests", () => {
  ...
  test("execute", async () => {
    ...
    expectTypeOf(result).toEqualTypeOf<ODataResponseModel<ODataEntityModelResponseV2<PersonModel>>>();
